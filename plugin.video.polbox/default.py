...
def ShowChannelsList(plugin, mode = 'TV'):
	...
	qqq = "xbmc.PLAYLIST_VIDEOxbmc.PLAYLIST_VIDEO %s" % xbmc.PLAYLIST_VIDEO	
	xbmc.log(qqq)
...
def VideoInfo(plugin, params):
	...
	for video in film['videos']:
		...
		icon = 'http://iptv.polbox.tv%s' % film['poster']
...
PLUGIN_CORE = iptv.polbox(USERNAME, USERPASS, PLUGIN_ID, SID, SID_NAME)
